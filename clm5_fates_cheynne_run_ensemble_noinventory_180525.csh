...
SETUP_CASE=fates_clm5_fullmodel_bci_parameter_ensemble_1pft_v002

if [ "${SETUP_CASE}" == "fates_clm5_fullmodel_bci_parameter_ensemble_1pft_v002" ]; then
