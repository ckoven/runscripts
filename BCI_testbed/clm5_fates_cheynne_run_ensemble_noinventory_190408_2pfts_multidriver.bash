...
SETUP_CASE=fates_clm5_fullmodel_bci_parameter_ensemble_2pfts_190408_multiinst_36inst_noinv

if [ "${SETUP_CASE}" == "fates_clm5_fullmodel_bci_parameter_ensemble_2pfts_190408_multiinst_36inst_noinv" ]; then
...
fates_paramfile = '/glade/scratch/charlie/parameter_file_sandbox/fates_params_default_106ac7a_mod2PFTs_exp1_${expstr}.c190408.nc'
