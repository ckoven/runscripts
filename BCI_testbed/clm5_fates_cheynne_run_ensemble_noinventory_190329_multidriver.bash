...
SETUP_CASE=fates_clm5_fullmodel_bci_parameter_ensemble_1pft_190329_multiinst_576inst

if [ "${SETUP_CASE}" == "fates_clm5_fullmodel_bci_parameter_ensemble_1pft_190329_multiinst_576inst" ]; then
...
fates_paramfile = '/glade/scratch/charlie/parameter_file_sandbox/fates_params_default_106ac7a_mod1PFT_exp1_${expstr}.c190329.nc'
