...
SETUP_CASE=fates_clm5_fullmodel_bci_parameter_ensemble_1pft_190201_v7_5inst

if [ "${SETUP_CASE}" == "fates_clm5_fullmodel_bci_parameter_ensemble_1pft_190201_v7_5inst" ]; then
...
fates_paramfile = '$HOME/scratch/parameter_file_sandbox/fates_params_default_d86e8b0_mod1PFT_exp1_${expstr}.c190319.nc'
