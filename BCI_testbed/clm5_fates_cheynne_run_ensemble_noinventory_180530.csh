...
SETUP_CASE=fates_clm5_fullmodel_bci_parameter_ensemble_1pft_v005

if [ "${SETUP_CASE}" == "fates_clm5_fullmodel_bci_parameter_ensemble_1pft_v005" ]; then
...
fates_paramfile = '/glade2/scratch2/charlie/parameter_file_sandbox/fates_params_c6ff126_bcitraits_test01_v_${expstr}.c180530.nc'
