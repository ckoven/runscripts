...
SETUP_CASE=fates_clm5_fullmodel_bci_parameter_ensemble_1pft_190201_singleinst_NOTFATES

if [ "${SETUP_CASE}" == "fates_clm5_fullmodel_bci_parameter_ensemble_1pft_190201_singleinst_NOTFATES" ]; then
    ...
    project=P93300041
    ninst=1
    ./create_newcase -case ${CASE_NAME} -res ${RES} -compset I2000Clm50BgcCruGs -mach cheyenne -project $project --run-unsupported
