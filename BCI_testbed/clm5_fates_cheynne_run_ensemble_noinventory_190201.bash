...
SETUP_CASE=fates_clm5_fullmodel_bci_parameter_ensemble_1pft_190201

if [ "${SETUP_CASE}" == "fates_clm5_fullmodel_bci_parameter_ensemble_1pft_190201" ]; then
    ...
    for x  in `seq 1 1 575`; do
	expstr=$(printf %04d $x)
	echo $expstr
	cat > user_nl_clm_$expstr <<EOF
fsurdat = '${CLM_SURFDAT_DIR}/${CLM_USRDAT_SURDAT}'
fates_paramfile = '/glade/scratch/charlie/parameter_file_sandbox/fates_params_default_de69ba3_mod1PFT_exp1_${expstr}.c190201.nc'
...
EOF
    ...
    ./preview_namelists
    cp /glade/scratch/charlie/$CASE_NAME/run/datm.streams.txt.CLM1PT.CLM_USRDAT user_datm.streams.txt.CLM1PT.CLM_USRDAT
