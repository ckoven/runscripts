...
SETUP_CASE=fates_clm5_fullmodel_bci_parameter_ensemble_1pft_190201_multiinst4

if [ "${SETUP_CASE}" == "fates_clm5_fullmodel_bci_parameter_ensemble_1pft_190201_multiinst4" ]; then
...
#hist_mfilt = 60, 10
#hist_nhtfrq = 0, -8760
#hist_fexcl1 = 'PFTbiomass','PFTleafbiomass','PFTstorebiomass','PFTnindivs','RECRUITMENT','MORTALITY','PATCH_AREA_BY_AGE','LAI_BY_AGE','CANOPY_AREA_BY_AGE','CANOPY_HEIGHT_DIST','LEAF_HEIGHT_DIST','FUEL_MOISTURE_NFSC','CROWNAREA_CAN','NPLANT_SCAG','DDBH_CANOPY_SCLS','DDBH_UNDERSTORY_SCLS','BA_SCLS','AGB_SCLS','NPLANT_CANOPY_SCLS','LAI_CANOPY_SCLS','MORTALITY_CANOPY_SCLS','NPLANT_UNDERSTORY_SCLS','LAI_UNDERSTORY_SCLS','NPLANT_SCLS','M1_SCLS','M2_SCLS','M3_SCLS','M4_SCLS','M5_SCLS','M6_SCLS','M7_SCLS','M8_SCLS','MORTALITY_UNDERSTORY_SCLS'
    for x  in `seq 1 1 $ninst`; do
	expstr=$(printf %04d $x)
	echo $expstr
	cat > user_nl_clm <<EOF
fsurdat = '${CLM_SURFDAT_DIR}/${CLM_USRDAT_SURDAT}'
fates_paramfile = '/glade/scratch/charlie/parameter_file_sandbox/fates_params_default_d86e8b0_mod1PFT_exp1_${expstr}.c190319.nc'
