...
SETUP_CASE=fates_clm5_fullmodel_bci_parameter_ensemble_exp3_10pfts_190422_multiinst_576inst_v3
...
#fates_paramfile = '/glade/scratch/charlie/parameter_file_sandbox/fates_params_default_0bc7a5d_mod3PFTs_exp3_${expstr}.c190422.nc'
for x  in `seq 1 1 $ninst`; do
    expstr=$(printf %04d $x)
    echo $expstr
    cat > user_nl_clm_$expstr <<EOF
fsurdat = '${CLM_SURFDAT_DIR}/${CLM_USRDAT_SURDAT}'
fates_paramfile = '/glade/scratch/charlie/parameter_file_sandbox/fates_params_default_0bc7a5d_mod10PFTs_exp3_${expstr}.c190422.nc'
