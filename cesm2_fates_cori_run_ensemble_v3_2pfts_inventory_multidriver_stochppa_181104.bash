...
SETUP_CASE=fates_ctsm_cori_fullmodel_bci_parameter_ensemble_2pfts_v010_multidriver_inv_stochppa
...
project=m2467
ninst=767
./create_newcase -case ${CASE_NAME} -res ${RES} -compset I2000Clm50FatesGs -mach cori-knl -project $project --run-unsupported --ninst=$ninst --multi-driver
cd ${CASE_NAME}
...
fates_paramfile = '/global/homes/c/cdkoven/scratch/parameter_file_sandbox/fates_params_358720c_bcitraits_test03_2pfts_stochppa_${expstr}.c181104.nc'
